...
public:
  ...
  IMU(uint8_t mux_channel, uint8_t i2c_addr) :
  ...
  bool init() {
    ...
    Serial.println(this->mux_channel);

    set_multiplexer(this->mux_channel);
...
void setup() {
  ...
  Serial.println("Initializing first IMU...");
  imus[0].init();
  // Serial.println("Initializing second IMU...");
  // imus[1].init();
  // Serial.println("Initializing third IMU...");
  // imus[2].init();
...
void loop() {  
  ...
  Serial.print(imus[0].kalAngleY);
  Serial.print('\t');
  Serial.println(imus[1].kalAngleY);
  Serial.print('\t');
  Serial.print(imus[2].kalAngleY);

  Serial.print('\t');
  Serial.print('\t');
  Serial.print('\t');

  Serial.print(imus[0].kalAngleX);
  Serial.print('\t');
  Serial.println(imus[1].kalAngleX);
  Serial.print('\t');
  Serial.println(imus[2].kalAngleX);
  delay(2);
}
