...
// BLE setup
#define SERVICE_UUID           "0aca703c-8c82-4fea-9bcc-dfe99e64a024" // UART service UUID
#define CHARACTERISTIC_UUID_RX "0aca703c-8c82-4fea-9bcc-dfe99e64a024"
#define CHARACTERISTIC_UUID_TX "0aca703c-8c82-4fea-9bcc-dfe99e64a024"
...
void loop() {  
  ...
  // for (int i = 0; i < 5; i++) {    
  //   imuData += String(random(0, 90)) + ',';
  //   imuData += String(random(0, 90)) + ',';
  //   imuData += String(random(0, 90));
  //   if (i < 4) imuData += ",";
  // }
  //// END RANDOM DATA FOR TESTING ///
...
//     // // Print data to the serial monitor
  ...
  if (deviceConnected) {
    pTxCharacteristic->setValue("data"); // Convert string to char array for BLE
